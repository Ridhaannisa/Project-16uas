              ...
              <div class="card-body">
                <form action="{{url('beli')}}" method="post">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="exampleInputnama_pelanggan">Nama Pelanggan</label>
                   ...
                   <div class="form-group">
                    <label for="exampleInputno_handphone">No Handphone</label>
                  ...
                  <button type="submit" class="btn btn-dark shadow">Check Out</button>
                </form>
              </div>
            </div>
